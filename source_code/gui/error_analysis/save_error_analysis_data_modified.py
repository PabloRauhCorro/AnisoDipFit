...
def save_error_analysis_data(score_vs_parameters, best_parameters, err_settings, output_settings):
    if output_settings['save_data'] and not (score_vs_parameters == []):
        ...
        save_fitting_parameters(best_parameters, filename)
        # Save the score vs individual fitting parameters
        save_score_vs_parameters(err_settings['variables'], score_vs_parameters, output_settings['directory'])
        # Output status
